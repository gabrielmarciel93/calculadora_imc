...
//VALIDAÇÃO DOS VALORES DIGITADOS
  ...
  resultadoElement.innerHTML = textoFinalUsuario;
  
  

	var textoFinalUsuario = nome + 'seu peso é' + peso + 'sua altura é' +altura + ' portanto, seu imc é : ' + imc + ' - ')
	
	if IMC <=18.5 {
		textoFinalUsuario += 'ABAIXO DO PESO';
	}
